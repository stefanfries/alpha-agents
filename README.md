...
| **Monitoring** | Reconciles screening candidates with current holdings; classifies KEEP, SELL, and ROLL decisions; BREAK-triggered sells free slots for same-run entries |
...
| **Trade Execution** | Produces SELL orders for BREAK-triggered closes followed by BUY orders for approved entries (dry-run by default) |
...
| [docs/decisions/](docs/decisions/) | Architecture Decision Records (ADR-001 through ADR-012) |
